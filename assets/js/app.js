...
//Start to override alert
//open modal in window.open
//created by : khoa
...
window.alert = function (message, title) {
    ...
    if ($("#bootstrap-alert-box-modal").length == 0) {
        ...
        <div class="modal-header" style="min-height:40px;padding-top:15px;">\
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>\
        <h4 class="modal-title"></h4>\
        </div>\
        <div class="modal-body" style="min-height:60px;"><p></p></div>\
...
//created by : khoa
//created date : 1/7/2014
window.bootstrapConfirm = function (message, callback, title, yesLabel) {
    title = typeof title !== 'undefined' ? title : 'Notification';
    $("#bootstrap-confirm-box-modal").data('confirm-yes', false);
    if ($("#bootstrap-confirm-box-modal").length == 0) {
        $("body").append('<div id="bootstrap-confirm-box-modal" data-tabindex="1000" class="modal fade" >\
            <div class="modal-dialog">\
            <div class="modal-content">\
            <div class="modal-header" style="min-height:40px; padding-top:15px;">\
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>\
        ...
        $("#bootstrap-confirm-box-modal").on('hide.bs.modal', function () {
            if ($("#bootstrap-confirm-box-modal").data('confirm-yes') == true) callback();
        });
    }
...
// open modal in another modal when deleting
//created by : khoa
//created date : 1/7/2014
window.bootstrapDialogConfirm = function (message, callback) {
    $("#bootstrap-alert-box-popup").data('confirm-yes', false);
    $("#bootstrap-alert-box-popup .modal-footer .btn-primary").on('click', function () {
        $("#bootstrap-alert-box-popup").data('confirm-yes', true);
        $("#bootstrap-alert-box-popup").modal('hide');
        return false;
    });
    $("#bootstrap-alert-box-popup").on('hide.bs.modal', function () {
        if ($("#bootstrap-alert-box-popup").data('confirm-yes') == true) callback();
    });
    $("#bootstrap-alert-box-popup .modal-body p").text(message || "");
    $("#bootstrap-alert-box-popup").modal('show');
};
//End of alert
