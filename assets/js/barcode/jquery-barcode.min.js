function CODE128(c) {
    ...
    89], ["z", "11011110110", 90], ["{", "11110110110", 91], ["|", "10101111000", 92], ["}", "10100011110", 93], ["~", "10001011110", 94], ["DEL", "10111101000", 95], ["FNC3", "10111100010", 96], ["FNC2", "11110101000", 97], ["SHIFT", "11110100010", 98], ["Code C", "10111011110", 99], ["FNC4", "10111101110", 100], ["Code A", "11101011110", 101], ["FNC1", "11110101110", 102], ["START A", "11010000100", 103], ["START B", "11010010000", 104], ["START C", "11010011100", 105]], i = "11010010000", j = "1100011101011", h = /^[!-~ ]+$/
}; function EAN(c) {
    function k(f, a) { for (var b = "", e = 0; e < f.length; e++) "L" == a[e] ? b += i[f[e]] : "G" == a[e] ? b += j[f[e]] : "R" == a[e] && (b += h[f[e]]); return b } function a(a) { if (-1 == a.search(g)) return !1; for (var b = a[12], d = 0, e = 0; 12 > e; e += 2) d += parseInt(a[e]); for (e = 1; 12 > e; e += 2) d += 3 * parseInt(a[e]); return b == (10 - d % 10) % 10 } this.EANnumber = c + ""; this.valid = function () { return a(this.EANnumber) }; this.encoded = function () {
        if (a(this.EANnumber)) {
            var f = this.EANnumber, c = "", g = f[0], e = f.substr(1, 7), f = f.substr(7, 6), c = c + m, c = c + k(e, b[g]), c = c + d, c =
            c + k(f, "RRRRRR"); return c += l
        } return ""
    }; var i = { "0": "0001101", 1: "0011001", 2: "0010011", 3: "0111101", 4: "0100011", 5: "0110001", 6: "0101111", 7: "0111011", 8: "0110111", 9: "0001011" }, j = { "0": "0100111", 1: "0110011", 2: "0011011", 3: "0100001", 4: "0011101", 5: "0111001", 6: "0000101", 7: "0010001", 8: "0001001", 9: "0010111" }, h = { "0": "1110010", 1: "1100110", 2: "1101100", 3: "1000010", 4: "1011100", 5: "1001110", 6: "1010000", 7: "1000100", 8: "1001000", 9: "1110100" }, b = {
        "0": "LLLLLL", 1: "LLGLGG", 2: "LLGGLG", 3: "LLGGGL", 4: "LGLLGG", 5: "LGGLLG", 6: "LGGGLL",
        7: "LGLGLG", 8: "LGLGGL", 9: "LGGLGL"
    }, m = "101", l = "101", d = "01010", g = /^[0-9]{13}$/
} function UPC(c) { this.ean = new EAN("0" + c); this.valid = function () { return this.ean.valid() }; this.encoded = function () { return this.ean.encoded() } }; (function (c) {
    c.fn.JsBarcode = function (k, a) {
        var a = c.extend({}, c.fn.JsBarcode.defaults, a), i = document.createElement("canvas"); if (!i.getContext) return this; var j = new CODE128(k); if (!j.valid()) return this; var j = j.encoded(), h = i.getContext("2d"); i.width = j.length * a.width + 2 * a.quite; i.height = a.height; h.fillStyle = "#fff"; h.fillRect(0, 0, i.width, i.height); for (var b = 0; b < j.length; b++) { var m = b * a.width + a.quite; h.fillStyle = "1" == j[b] ? "#000" : "#fff"; h.fillRect(m, 0, a.width, a.height) } uri = i.toDataURL("image/png"); return c(this).attr("src",
        uri)
    }; c.fn.JsBarcode.defaults = { width: 2, height: 100, quite: 10, format: "CODE128" }
})(jQuery);